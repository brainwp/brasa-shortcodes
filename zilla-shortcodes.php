<?php
/*
Plugin Name: Brasa Shortcodes
Description: Um gerador de shortcodes para adicionar bot&otilde;es, colunas e tabs no seu tema.
Version: 1.1
Author: ThemeZilla e Brasa
...
class ZillaShortcodes {
	...
	function admin_init()
	{
		...
		wp_localize_script( 'jquery', 'ZillaShortcodes', array('plugin_folder' => WP_PLUGIN_URL .'/brasa-shortcodes') );
	}
